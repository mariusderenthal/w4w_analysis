...
path_river = path_inter/'rivers'/'rio_sogamoso.gpkg'
...
riverList = [river_500, river_2000, river_5000, river_10000,river_25000, river_50000, river_150000]  # List of your dataframes
...
'''
# exporting ############################################################################################################
municipalties.to_file(path_inter / "study_area/municipalties_SA.gpkg", driver="GPKG")
catchment_SA.to_file(path_inter / "study_area/catchments_SA.gpkg", driver="GPKG")
river_buffered.to_file(path_inter / "study_area/river_buffer.gpkg", driver="GPKG")
